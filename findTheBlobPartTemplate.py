...
# Let's write some code to find blue.
...
# This function does either two things
# Either gives you the average x cooredinate of green  
# or when it finds it , it gives back -1

# This is a while loop to find green.
while (position != -1): # != is the symbol for not equals to 
    picture = takePicture()
    position = findColorSpot(picture, green)
    print(position)          
